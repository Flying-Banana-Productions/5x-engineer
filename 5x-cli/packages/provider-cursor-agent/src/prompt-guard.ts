/**
 * Prompt size is passed on the command line (final positional arg). Enforce a byte
 * budget before spawn so failures are deterministic and we never rely on shell/OS
 * argv limits alone.
 *
